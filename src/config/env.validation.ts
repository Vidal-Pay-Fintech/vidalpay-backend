...
const schema: Record<string, EnvSchemaEntry> = {
  ...
  ONESIGNAL_ORG_API_KEY: { type: 'string', default: '' },
  ONESIGNAL_TEST_SUBSCRIPTION_ID: { type: 'string', default: '' },
  SARDINE_BASE_URL: { type: 'string', default: '' },
